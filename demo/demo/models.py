...
class Showcase(models.Model):
    ...
    textfield = models.TextField(
        blank=True, verbose_name="Autosized textfield", help_text="Try and enter few some more lines"
    )
    ...
    country2 = models.ForeignKey(
        Country, null=True, blank=True, related_name="showcase_country2_set", verbose_name="Django Select 2"
    )
